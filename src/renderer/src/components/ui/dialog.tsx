...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 text-zinc-500 hover:text-zinc-300 hover:bg-white/5 transition-colors focus:outline-none">
        <X className="h-4 w-4" />
